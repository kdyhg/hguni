...
> 상태: 2026-09-22의 초기 클라우드 계획. 이후 사용자 결정에 따라 Supabase/Vercel 부분은 [`../local-architecture.md`](../local-architecture.md)의 Windows + SQLite 구조로 대체되었다. 화면·업무·유니쿨 안전 요구사항은 계속 유효하다.
